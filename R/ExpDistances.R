...
#' @title Internal functions for estimating pair-wise transcriptome distances
#'
#' @name distances
#'
#' @rdname distances
#'
#' @description Several published methods to estimate pair-wise transcriptome distances.
#'
#' Distance methods used to analyze expression values include Pearson distance,
#' Euclidean distance, angular-cosine distance, the square root of
...
#'
#' @export
Expdist.u = function (reads.count = NULL, gene_length = NULL) {
...
#'
#' @export
Expdist.jsd = function (expMat = NULL) {
...
#'
#' @export
Expdist.pea = function (expMat = NULL) {
...
#'
#' @export
Expdist.spe = function (expMat = NULL) {
...
#'
#' @export
Expdist.euc = function (expMat = NULL) {
...
#'
#' @export
Expdist.cos = function (expMat = NULL) {
...
#'
#' @export
Expdist.tani = function (expMat = NULL) {
...
#'
#' @export
Expdist.jac = function (expMat = NULL) {
...
#'
#' @export
Expdist.ced = function (expMat = NULL) {
...
#'
#' @export
Expdist.sou = function (expMat = NULL) {
